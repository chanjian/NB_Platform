"""
Django settings for 刷票管理系统2_优化短信登录 project.
...
SECRET_KEY = 'django-insecure-4==7ao)$s7q=__n(g*43y8opuc0#ii*8u_n+*0xc9(emo3ux1$'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.31.48','*']
...
WSGI_APPLICATION = 'NB_Platform.wsgi.application'
...
NB_MENU = {
    'ADMIN': [
...

        {
            ...
            'icon': "fa-bed",
            'children': [
                {'text': "日志模块", 'url': "/logging_module/pratice/", 'name': "logging_module_practice"},
                {'text': "日志模块-配合settings", 'url': "/logging_module/pratice/settings/", 'name': "logging_module_practice_settings"},
                # {'text': "价格策略", 'url': "/policy/list/", 'name': "policy_list"},
            ]
        },
